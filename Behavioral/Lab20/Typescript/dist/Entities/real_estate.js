...
var RealEstate = /** @class */ (function (_super) {
    ...
    function RealEstate(address, description, area, price, status) {
        ...
        // Bools
        _this.isAlreadyRented = false;
        _this.isAlreadySold = false;
        _this.isAlreadyBought = false;
    ...
    RealEstate.prototype.toString = function () {
        return "Id: ".concat(this.id, ", Address: ").concat(this.address, ",\nDescription: ").concat(this.description, ",\nArea: ").concat(this.area, ", Price: ").concat(this.priceInUSD, "\nStatus: ").concat(this.status, "\n").concat(this.realtor, "\nFurnished: ").concat(this.furnished, ", ") +
            "Parking: ".concat(this.parking, ", Balcony: ").concat(this.balcony, ", Elevator: ").concat(this.elevator, ", Air conditioning: ").concat(this.airConditioning, ", Utilities included: ").concat(this.isUtilitiesIncluded, "\n");
    };
    RealEstate.prototype.printEstateInfo = function (tab) {
        if (tab === void 0) { tab = ""; }
        console.log(tab + this.toString().replace(/\n/g, "\n" + tab));
    };
    RealEstate.prototype.rent = function (customer, startDate, endDate) {
        this.state.rent(customer, startDate, endDate);
    };
    RealEstate.prototype.sell = function (customer) {
        this.state.sell(customer);
    };
    RealEstate.prototype.setEstateToBuy = function (customer, price) {
        this.state.setEstateToBuy(customer, price);
    };
