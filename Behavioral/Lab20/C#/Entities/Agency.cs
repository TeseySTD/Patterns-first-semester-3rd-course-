...
namespace C_.Entities
{
    public class Agency
    {
        ...
        public void Notify(string message) 
        {
            switch (message) 
            {
                case "Estates protfolio":
                    _estateSubsystem.MainAction(_apartments,false);
                    _estateSubsystem.MainAction(_rooms,false);
                    _estateSubsystem.MainAction(_houses,false);
                    break;
                case "Realtors protfolio":
                    _realtorSubsystem.MainAction(_realtors,false);
                    break;
                default:
