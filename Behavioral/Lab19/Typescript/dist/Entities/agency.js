...
var realtor_subsystem_1 = require("../realtor_subsystem");
var estate_subsystem_1 = require("../estate_subsystem");
var Agency = /** @class */ (function () {
    ...
    Agency.Notify = function (message) {
        switch (message) {
            case "realtor":
                Agency._realtorSubsystem.MainAction(this._realtors, false);
                break;
            case "estate":
                Agency._estateSubsystem.MainAction(this._apartments, false);
                Agency._estateSubsystem.MainAction(this._rooms, false);
                Agency._estateSubsystem.MainAction(this._houses, false);
                break;
        }
    };
    ...
    Agency._realtorSubsystem = new realtor_subsystem_1.RealtorSubsystem();
    Agency._estateSubsystem = new estate_subsystem_1.EstateSubsystem();
    return Agency;
}());
