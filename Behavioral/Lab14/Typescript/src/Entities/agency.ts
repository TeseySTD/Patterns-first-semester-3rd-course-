...
export class Agency {
    ...
    private static _realtors: RealtorAbstract[];
    ...
    public get Realtors(): RealtorAbstract[] {
            return Agency._realtors;
        
    }

    public AddRealtor(realtor: RealtorAbstract): void {
            Agency._realtors.push(realtor);
        
    }

    public RemoveRealtor(realtor: RealtorAbstract): void {
