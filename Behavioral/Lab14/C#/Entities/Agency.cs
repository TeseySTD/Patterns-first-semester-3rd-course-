...
namespace C_.Entities
{
    public class Agency
    {
        private Agency() {
            ...
            _realtors = new List<RealtorAbstract>();
        ...
        private static List<RealtorAbstract> _realtors;
        ...
        public List<RealtorAbstract> Realtors 
        { 
            get 
            {
                lock (_lockRealtors)
        ...
        public void AddRealtor(RealtorAbstract realtor){
            lock (_lockRealtors) {
                _realtors.Add(realtor);
            }
        }
        public void RemoveRealtor(RealtorAbstract realtor){
            lock(_lockRealtors) {
