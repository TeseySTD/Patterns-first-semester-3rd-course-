...
{
    public class RelatorHouse : RealtorAbstract
    {
        public RelatorHouse(string nameAndSurname, string phone, string email, double yearsOfWork) : base(nameAndSurname, phone, email, yearsOfWork)
        {
        }
