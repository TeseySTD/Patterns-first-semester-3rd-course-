...
var Agency = /** @class */ (function () {
    ...
    Agency.prototype.RemoveEstateByIndex = function (type, index) {
        switch (type.toLowerCase()) {
            case "apartment":
                var apartment = Agency._apartments.find(function (a) { return a.id == index; });
                if (apartment != null)
                ...
                break;
            case "room":
                var room = Agency._rooms.find(function (r) { return r.id == index; });
                if (room != null)
                ...
                break;
            case "house":
                var house = Agency._houses.find(function (h) { return h.id == index; });
                if (house != null)
