...
exports.AddApartmentCommand = void 0;
...
var AddApartmentCommand = /** @class */ (function (_super) {
    __extends(AddApartmentCommand, _super);
    function AddApartmentCommand() {
        var params = [];
    ...
    AddApartmentCommand.prototype.execute = function () {
    ...
    return AddApartmentCommand;
}(abstract_command_1.AbstractCommand));
exports.AddApartmentCommand = AddApartmentCommand;
