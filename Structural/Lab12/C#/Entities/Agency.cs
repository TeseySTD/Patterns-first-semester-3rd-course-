...
namespace C_.Entities
{
    public class Agency
    {
        ...
        private readonly static EstateSubsystem _estateSubsystem = new EstateSubsystem();
        private readonly static RealtorSubsystem _realtorSubsystem = new RealtorSubsystem();
        ...
        public void PrintSubsystemsPortfolio(){
            Console.WriteLine(new StringBuilder().Append(_realtorSubsystem.RealtorsPortfolio(_realtors) )
                                                .Append("\n\nApartments:")
                                                .Append(_estateSubsystem.EstatePortfolio(_apartments) )
                                                .Append("\n\nRooms:")
                                                .Append(_estateSubsystem.EstatePortfolio(_rooms) )
                                                .Append("\n\nHouses:")
                                                .Append(_estateSubsystem.EstatePortfolio(_houses) ).ToString());
        }
    }
}
