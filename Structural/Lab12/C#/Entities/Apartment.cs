...
namespace C_.Entities
{
    public class Apartment : RealEstate
    {
        ...
        public Apartment(string address, string description, double area, 
                        double price, string status, int roomsNumber, RealEstateFlyweight intrinsicState) :
            base(address, description, area, price, status) {
            RoomsNumber = roomsNumber;
            base.intrinsicState = intrinsicState;
        }
