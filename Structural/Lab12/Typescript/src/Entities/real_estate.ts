...
export abstract class RealEstate extends AgencyObject implements ICloneable, IRentable, IBuyable, ISellable, IPrintEstateInfo {
    ...
    public intrinsicState: RealEstateFlyweight;
    ...
    public toString(): string {
        return `Id: ${this.id}, Address: ${this.address},\nDescription: ${this.description},\nArea: ${this.area}, Price: ${this.priceInUSD}\nStatus: ${this.status}\n${this.realtor}\n` +
            this.intrinsicState == null ? `Furnished: ${this.furnished}, Parking: ${this.parking}, Balcony: ${this.balcony}, Elevator: ${this.elevator}, Air conditioning: ${this.airConditioning}, Utilities included: ${this.isUtilitiesIncluded}\n` 
