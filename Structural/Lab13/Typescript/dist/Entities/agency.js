...
var Agency = /** @class */ (function () {
    ...
    Agency.prototype.FindEstateByID = function (id) {
        return Agency._apartments.find(function (a) { return a.id === id; }) ||
            Agency._rooms.find(function (a) { return a.id === id; }) ||
            Agency._houses.find(function (a) { return a.id === id; });
    };
