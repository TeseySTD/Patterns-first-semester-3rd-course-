...
})();
{
    var Program = /** @class */ (function () {
        ...
        Program.Main = function () {
            ...
            client.AddEstate(new House_1(150000));
            client.AddEstate(new Apartment_1(70000));
            console.log("Total cost of all estates: ".concat(client.GetTotalValue(), " \u0433\u0440\u043D."));
        };
        return Program;
    }());
    var Client_1 = /** @class */ (function () {
        ...
        Client.prototype.GetTotalValue = function () {
            return this._estates.reduce(function (prev, current) { return prev + current.Value; }, 0);
        };
        return Client;
    }());
