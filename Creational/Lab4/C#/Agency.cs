...
namespace C_
{
    public class Agency
    {
        ...
        // public void RentOrSellRandomEstate(){
        //     Random r = new Random();
        //     int i = r.Next(2);
        //     switch (i){
        //         case 0:
        //             RentOrSellEstate(new ApartmentCreator());
        //             break;
        //         case 1:
        //             RentOrSellEstate(new RoomCreator());
        //             break;
        //         case 2:
        //             RentOrSellEstate(new HouseCreator());
        //             break;
        //     }
        // }

        // public void CreateRandomAgencyObject(){
        //     Random r = new Random();
        //     int i = r.Next(4);
        // }

        // private void RentOrSellEstate(RealEstateCreator creator){
        //     creator.RentEstate(new Customer(), Convert.ToDateTime("2024-08-08"), Convert.ToDateTime("2024-09-08"));
        //     creator.SellEstate(new Customer());
        // }
